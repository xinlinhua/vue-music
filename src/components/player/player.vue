                    ...
                    <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
                        <div class="lyric-wrapper">
                            <div v-if="currentLyric" >
                                <p v-for="(lyric,index) in currentLyric.lines" :key="index"
                ...
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progress-bar :percent="percent" @percentChange="onPregressChange">  </progress-bar>
                        </div>
    ...
    methods:{
        ...
        middleTouchMove(e){
           ...
           if(!this.touch.initiated){
            ...
            this.$refs.lyricList.$el.style[transitionDuraction] = 0 
            this.$refs.middleL.style.opacity = 1 -  this.touch.percent
            this.$refs.middleL.style[transitionDuraction] = 0 
        ...
        middleTouchEnd(e){
            ...
            this.$refs.lyricList.$el.style[transform] = `translate3d(${offsetWidth}px,0,0)`
            this.$refs.lyricList.$el.style[transitionDuraction] = `${time}ms`
            this.$refs.middleL.style.opacity = opacity
            this.$refs.middleL.style[transitionDuraction] = `${time}ms` 
